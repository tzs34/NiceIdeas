...
class AnimeRTGList extends React.Component {
  constructor() {
    super()
      ...
      <div className="app-container">
        ...
        <TransitionGroup component="ul" className="list">
          {this.state.data.map(num => (
            <Transition key={num} timeout={500} mountOnEnter unmountOnExit>
              {status => {
